...
class App extends React.Component {
    state = {
        ...
        displays: [
            {name: 'Left Display', sourceIndex: 0, power: false, listen: false, icon: 'projector', routeJoin: '101', powerJoin: '51', powerOffJoin: '55', listenJoin: '61'},
            {name: 'Right Display', sourceIndex: 0, power: false, liste: false, icon: 'projector', routeJoin: '102', powerJoin: '52', powerOffJoin: '56', listenJoin: '62'},
            {name: 'Monitor', sourceIndex: 0, power: false, listen: false, icon: 'display', routeJoin: '101', powerJoin: '51', powerOffJoin: '55', listenJoin: '61'},
        ],
    ...
    /* API *******************************************************************************************************************************************/
    getSources = () => {
        getSettings('192.168.0.3','9000','sources')
        .then(resJson => this.setState({sources: resJson.sources.sources}))
        // .then(resJson => console.log('resJson = ',resJson.sources.sources))
    }
    getDisplays = () => {
        getSettings('192.168.0.3','9000','displays')
        .then(displays => {
            this.setState({displays})
    ...
    getCatvPresets = () => {
        getSettings('192.168.0.3','9000','catvPresets')
        .then(catvPresets => this.setState({catvPresets}))
    }
    getVcDirectoryItems = () => {
        getSettings('192.168.0.3','9000','VcDirectoryItems')
